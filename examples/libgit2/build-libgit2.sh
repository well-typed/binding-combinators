...
#
# cmake and a C toolchain are pulled from nixpkgs via `nix shell`, so no system
# packages are required. HTTPS/SSH are disabled and regex/zlib/http-parser use libgit2's
