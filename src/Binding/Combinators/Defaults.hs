...
-- @output defaultOut@ and @defaultRes@, or let "Binding.Combinators.Auto" fill them
-- in for you.
--
...
--
module Binding.Combinators.Defaults (
    DefaultIn (..)
  , DefaultOut (..)
  , DefaultRes (..)
  , defaultRes
...
import Binding.Combinators (ToHighLevel, resultIO)
import Binding.Combinators.Internal.Errors (NoDefault, unreachable)
import Binding.Combinators.Marshaller
import Binding.Combinators.Marshaller.Utils (constByteStringLenIn, funPtrIn,
...
-- "Binding.Combinators.Marshaller.Utils".
--
-- Both parameters are already known at an 'Binding.Combinators.output', @c@ from the C
...
-- "Binding.Combinators.Auto" has to splice it into a larger assembler when the spec
...
--
-- It is 'Binding.Combinators.Auto.autoResult' restricted to an output-free spec,
