...
--
module Binding.Combinators.Internal.Errors (
    NoDefault
  , AutoMismatch
  , AutoResultMismatch
  , AutoOutputsMismatch
...
-- ('Binding.Combinators.Auto.checkedResult',
-- 'Binding.Combinators.Auto.maybeResult',
-- 'Binding.Combinators.Auto.eitherResult'). @os@ is the list of out-parameter Haskell
-- types and @hs@ the result the signature asks for.
--
...
unreachable :: a
unreachable = errorWithoutStackTrace "Binding.Combinators: unreachable"
